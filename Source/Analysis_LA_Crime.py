...
# %% [markdown]
# Exclude the description `mocodes_desc` before saving, as it will be stored as a string and may introduce errors (due to commas, etc.).

# %%
crime_df.drop(columns=['mocodes_desc']).to_csv('../Data/crime_data_cleaned.csv', index = False)
